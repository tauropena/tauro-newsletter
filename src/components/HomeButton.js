...
export default function HomeButton() {
  return (
    <li className="inline-flex items-center">
      <Link
        href="/home"
        className=" bg-secondary border border-background rounded-full px-3 py-1 inline-flex items-center text-background hover:translate-y-[-0.25rem] hover:shadow-[0_0.25rem_0_0_#CC6378] transition duration-300"
      >
        <svg
